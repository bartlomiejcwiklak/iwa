package pl.dmcs.rkotas.task2.model;

public class Mathematics {
    private long fibonacciN;
    ...
    public long getFibonacciN() { return fibonacciN; }
    public void setFibonacciN(long fibonacciN) { this.fibonacciN = fibonacciN; }
